...
void withdrawDiaglog(BuildContext context) async{
  String? result = await showDialog(
    context: context,
    barrierDismissible: true,
    builder: (BuildContext context){
      return AlertDialog(
        title: const Text("정말 읏차 서비스를 탈퇴하시겠어요?"),
        content: const Text("서비스 탈퇴 시 계정 정보 및 게시글은 모두 삭제되어 복구가 불가능합니다. 정말 탈퇴하시겠어요?"),
        actions: <Widget[
          Row(
